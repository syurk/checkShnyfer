...
from .accountutils import handleManageCheckRequest

app_name = 'manageaccounts_app'

def index(request):
    return render(request, 'manageaccounts/index.html', {"accounts": Account.objects.order_by('-account_id').exclude(fname="")})
